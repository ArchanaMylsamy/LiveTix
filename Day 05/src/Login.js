        ...
        <div class="inner-box">
          <div class="forms-wrap">
            <form action="index.html" autocomplete="off" class="sign-in-form">
              ...
              <div class="heading">
                <h2>Welcome<img className="hi" src="https://media1.tenor.com/images/f88ee476d2f653b9cbc5a7b95acbd265/tenor.gif?itemid=11366012"></img></h2>
              ...
              <Link to="/Signin">  <input type="submit" value="Sign Up" class="sign-btn" /></Link>
