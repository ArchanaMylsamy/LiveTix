...
<nav class="nav">
  ...
  <main>
    ...
    <div class="about-me">
      <div className='event1'><img src="https://th.bing.com/th/id/OIP.qHlGG80RfgmUU6WAWeCwygHaEK?pid=ImgDet&rs=1" alt="me"></img><p>ANIRUDH CONCERTS</p><p>14th JULY | CHENNAI</p><button className='button-33'><Link to="/Seating">BUY TICKETS</Link></button></div>&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
